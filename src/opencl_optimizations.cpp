...
void OpenCLWorkGroupSizeOptimization::apply(std::vector<std::shared_ptr<Tensor>>& tensors) {
...
void register_opencl_optimizations() {
    // empty bc registration is handled by REGISTER_OPTIMIZATION_PASS macro
}